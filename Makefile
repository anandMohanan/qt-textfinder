...
# Project:  textfinder.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile textfinder.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = textfinder1.0.0
DISTDIR = /home/anandm/projects/textfinder/.tmp/textfinder1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = main.cpp \
		textfinder.cpp qrc_textfinder.cpp \
		moc_textfinder.cpp
OBJECTS       = main.o \
		textfinder.o \
		qrc_textfinder.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		textfinder.pro textfinder.h main.cpp \
		textfinder.cpp
QMAKE_TARGET  = textfinder
DESTDIR       = 
TARGET        = textfinder
...
textfinder: ui_textfinder.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: textfinder.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		textfinder.pro \
		textfinder.qrc
	$(QMAKE) -o Makefile textfinder.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents textfinder.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents textfinder.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp textfinder.cpp $(DISTDIR)/
	$(COPY_FILE) --parents textfinder.ui $(DISTDIR)/
...
compiler_rcc_make_all: qrc_textfinder.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_textfinder.cpp
qrc_textfinder.cpp: textfinder.qrc \
		/usr/bin/rcc \
		input.txt
	/usr/bin/rcc -name textfinder textfinder.qrc -o qrc_textfinder.cpp
...
compiler_moc_header_make_all: moc_textfinder.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_textfinder.cpp
moc_textfinder.cpp: textfinder.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/anandm/projects/textfinder/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/anandm/projects/textfinder -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/11.1.0 -I/usr/include/c++/11.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/11.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include-fixed -I/usr/include textfinder.h -o moc_textfinder.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_textfinder.h
compiler_uic_clean:
	-$(DEL_FILE) ui_textfinder.h
ui_textfinder.h: textfinder.ui \
		/usr/bin/uic
	/usr/bin/uic textfinder.ui -o ui_textfinder.h
...
main.o: main.cpp textfinder.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

textfinder.o: textfinder.cpp textfinder.h \
		ui_textfinder.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o textfinder.o textfinder.cpp

qrc_textfinder.o: qrc_textfinder.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_textfinder.o qrc_textfinder.cpp

moc_textfinder.o: moc_textfinder.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_textfinder.o moc_textfinder.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/textfinder/bin || mkdir -p $(INSTALL_ROOT)/opt/textfinder/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/textfinder/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/textfinder/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/textfinder/bin/ 
